...
// with simple_solve_chemistry_enzo
/*
int solve_chemistry_enzo(int argc, char **argv) {
    ...
    double *abstol = (double*) malloc(sizeof(double)* N * 3);
    ...
    const char *fileloc = "/home/kwoksun2/dengo_install/simple_tables.h5";
    ...
    simple_solve_chemistry_enzo( units, field_data, dt );
    ...
    double ref0, frac;
    if (compare_array(field_data->H2_1_density, reltol, N) == 1)
        printf("H2_1 is not consistent\n");

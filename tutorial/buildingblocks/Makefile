...
# INSTALL PATHS
CVODE_PATH    = /home/kwoksun2/data/dengo-merge/cvode-5.3.0/instdir
SUITESPARSE_PATH = /home/kwoksun2/data/dengo-merge/suitesparse
...
# REQUIRED FILES
OBJ = simple_solver.C initialize_cvode_solver.C
TEST_OBJ = simple_solver_main.C
...
libdengo.la: $(addsuffix .lo, $(basename $(OBJ)) )
	...
	cp simple_solver.h $(DENGO_INSTALL_PATH)/include/
	cp simple_tables.h5 $(DENGO_INSTALL_PATH)

run_dengo: simple_solver_main.C
